package com.example.platform.orderservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseEntity<ErrorResponse>> handleValidation(MethodArgumentNotValidException ex) {
